...
<div class="side-body <?php echo getSideBodyClass(false); ?>">
    ...
    <div class="row">
        <div class="col-lg-12 content-right">
            ...
            echo CHtml::tag('p', array(), gT("Please be aware that tables including encryption should not be restored if they have been created in LimeSurvey 4 before version 4.5.1"));
